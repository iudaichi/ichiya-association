...
* [⌨️使用するブロックチェーン技術](system-structure/blockchain.md)
* [⚜️トークンの設計](system-structure/token.md)

## 組織

* [🏹組織構成](organization/platform.md)
* [🏢決定プロセス](organization/governance_process.md)
* [🧑‍⚖️法的枠組み](organization/legal.md)
...
* [🎗️役員の選出方法と役割](member-roles/board-member.md)
